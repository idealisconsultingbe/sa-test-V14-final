...
class SmartanalyticsExtractorBackend(models.Model):
    ...
    post_extract_code = fields.Text(string='Post-extract Code', default=lambda self: self._default_python_code(),
...
class SmartanalyticsExtractorExtract(models.Model):
    ...
    name = fields.Char(string='Name', required=True)
    backend_id = fields.Many2one('smartanalytics.extractor.backend', string='Backend', required=True, ondelete='cascade')
...
class SmartanalyticsExtractorExtractField(models.Model):
    ...
    extract_id = fields.Many2one('smartanalytics.extractor.extract', string='Extract', required=True, ondelete='cascade')
